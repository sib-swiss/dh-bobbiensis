...
import * as miradorAnnotations from "./mirador-annotations/umd/mirador-annotations.min.js";
...
Alpine.data("manuscriptAnnotation", (data = []) => ({
    ...
    init() {
        ...
        this.miradorInstance = new Mirador.viewer(
            ...
            // PLUGINS
            [
                miradorAnnotations.miradorAnnotationPlugin,
